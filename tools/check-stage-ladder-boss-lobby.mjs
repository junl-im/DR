...
requireText(main, 'v1054-engine-design-gesture-qa', 'lobby gesture final rescue token');
...
requireText(css, 'data-lobby-drag-rescue="v1054-engine-design-gesture-qa"', 'lobby drag CSS hook');
requireText(sw, 'dream-library-cache-v1.0.86', 'current service worker cache');
requireText(sw, 'texture-atlas-manifest-v1.0.86.json', 'current manifest cache');
requireText(sw, 'texture-atlas-manifest-v1.0.47.json', 'required baseline manifest cache');
