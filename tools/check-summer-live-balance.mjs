...
if (!main.includes('v1048-summer-live-balance-pass') && !main.includes('v1054-store-collection-link-vfx') && !main.includes('v1050-summer-finale-event-vfx') && !main.includes('v1054-season-store-reward-burst') && !main.includes('v1052-season-shop-history-burst') && !main.includes('v1054-season-store-detail-history')) errors.push('Missing summer live balance, event VFX, finale or shop history token');
...
if (!index.includes('data-season-pass="v1048-summer-reward-pass-track"') && !index.includes('data-season-pass="v1054-store-collection-pass"') && !index.includes('data-season-pass="v1050-summer-finale-pass-shop"') && !index.includes('data-season-pass="v1054-season-store-reward-burst"') && !index.includes('data-season-pass="v1052-season-shop-reward-polish-pass"') && !index.includes('data-season-pass="v1054-season-store-detail-history"')) errors.push('Missing season pass lobby mount');
has(css, 'season-pass-track', 'season pass CSS');
if (!css.includes('v1048-campaign-gesture-fluid') && !css.includes('v1054-engine-design-gesture-qa') && !css.includes('v1050-summer-design-gesture-qa') && !css.includes('v1051-mobile-design-gesture-final') && !css.includes('v1052-mobile-store-gesture-qa') && !css.includes('v1053-history-density-gesture-qa')) errors.push('Missing campaign gesture CSS token');
if (!sw.includes('dream-library-cache-v1.0.86') && !sw.includes('dream-library-cache-v1.0.86') && !sw.includes('dream-library-cache-v1.0.86') && !sw.includes('dream-library-cache-v1.0.86') && !sw.includes('dream-library-cache-v1.0.86') && !sw.includes('dream-library-cache-v1.0.86')) errors.push('Missing service worker v1.0.48-v1.0.53 cache');
