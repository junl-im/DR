...
if (!renderer.includes('TILE_GEOMETRY_GUARD_LABEL') || !renderer.includes('enforceTileBodyGeometry') || !renderer.includes('assertTileBodyGeometry')) errors.push('Missing v1.0.40 hard tile geometry guard helpers.');
