...
if (!renderer.includes('TILE_GEOMETRY_GUARD_LABEL') || !renderer.includes('enforceTileBodyGeometry') || !renderer.includes('assertTileBodyGeometry')) errors.push('Missing v1.0.38 hard tile geometry guard helpers.');
