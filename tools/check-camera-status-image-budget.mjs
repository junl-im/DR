...
if (files.pkg.version !== '1.0.81') errors.push(`package version must be 1.0.81, got ${files.pkg.version}`);
...
console.log('Camera/status/image budget QA passed for v1.0.81.');
