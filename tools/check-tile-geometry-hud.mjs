...
if (!packageJson.includes('"version": "1.0.47"') && !packageJson.includes('"version": "1.0.48"') && (!packageJson.includes('"version": "1.0.49"') && !packageJson.includes('"version": "1.0.51"') && !packageJson.includes('"version": "1.0.52"'))) errors.push('package.json version must be 1.0.47, 1.0.48, 1.0.49 or 1.0.50.');
