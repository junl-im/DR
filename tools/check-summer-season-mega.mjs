...
requireText(main, 'v1048-summer-live-balance-pass', 'summer patch token');
...
requireText(main, 'v1048-campaign-gesture-fluid', 'season lobby drag token');
requireText(main, 'dy > 1.2', 'lobby drag threshold refinement');
requireText(main, 'dx * 0.28', 'lobby horizontal tolerance refinement');
requireText(css, 'v1048-summer-live-balance-pass', 'summer CSS token');
requireText(css, 'next-goal-v1048-summer-pass', 'summer stage map CSS token');
requireText(sw, 'dream-library-cache-v1.0.48', 'service worker v1.0.48 cache');
requireText(sw, 'texture-atlas-manifest-v1.0.48.json', 'v1.0.48 atlas manifest');
