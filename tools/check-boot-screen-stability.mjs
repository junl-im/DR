...
if (!sw.includes('dream-library-cache-v1.0.86')) errors.push('Service worker cache version must match current v1.0.86.');
...
console.log('Boot screen stability check passed: startup is forced to the intended first screen and the current SW avoids stale document cache.');
