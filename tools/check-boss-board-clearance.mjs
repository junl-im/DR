...
if (!['1.0.77', '1.0.78', '1.0.79', '1.0.80', '1.0.81'].includes(files.pkg.version)) errors.push(`package version must be 1.0.77 or 1.0.78, got ${files.pkg.version}`);
...
console.log('Boss board clearance QA passed for v1.0.77.');
