...
if (pkg.version !== '1.0.50') errors.push(`package version must be 1.0.50, got ${pkg.version}`);
...
has(main, 'v1050-summer-season-shop', 'summer season shop token');
has(main, 'v1050-summer-finale-missions', 'summer finale missions token');
...
has(css, 'v1050-summer-design-gesture-qa', 'design gesture QA CSS');
has(css, 'v1050-finale-compact-carousel', 'finale compact carousel CSS');
has(index, 'data-season-shop="v1050-summer-season-shop"', 'season shop panel attribute');
has(index, 'data-finale-missions="v1050-summer-finale-missions"', 'finale missions panel attribute');
has(sw, 'dream-library-cache-v1.0.50', 'service worker v1.0.50 cache');
has(sw, 'texture-atlas-manifest-v1.0.50.json', 'v1.0.50 atlas manifest preload');
has(difficulty, 'texture-atlas-manifest-v1.0.50.json', 'v1.0.50 atlas manifest difficulty preload');
if (!existsSync('public/assets/meta/texture-atlas-manifest-v1.0.50.json')) errors.push('missing v1.0.50 texture atlas manifest');
