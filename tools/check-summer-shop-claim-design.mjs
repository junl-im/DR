...
if (!['1.0.51', '1.0.52', '1.0.53', '1.0.54', '1.0.55', '1.0.56', '1.0.57', '1.0.58', '1.0.59', '1.0.60', '1.0.61', '1.0.62'].includes(pkg.version)) errors.push(`package version must be 1.0.51-1.0.53, got ${pkg.version}`);
