...
if (!['1.0.76', '1.0.77', '1.0.78', '1.0.79'].includes(files.pkg.version)) errors.push(`package version must be 1.0.76+ compatibility range through 1.0.77, got ${files.pkg.version}`);
