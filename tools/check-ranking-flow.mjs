...
if (!main.includes('refreshRankingPanelsAfterScore') || !main.includes('Promise.allSettled([loadLeaderboard(), loadDailyLeaderboard()]')) errors.push('ranking panels must refresh after score save');
...
console.log('Ranking flow policy passed for v1.0.26.');
