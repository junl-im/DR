...
if (!['1.0.71', '1.0.72', '1.0.73', '1.0.74', '1.0.75', '1.0.76', '1.0.77', '1.0.78', '1.0.79'].includes(files.pkg.version)) errors.push(`package version must be 1.0.71 or 1.0.72, got ${files.pkg.version}`);
