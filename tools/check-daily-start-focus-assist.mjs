...
if (!['1.0.62', '1.0.63', '1.0.64', '1.0.65', '1.0.66', '1.0.67', '1.0.68', '1.0.69', '1.0.70', '1.0.71', '1.0.72', '1.0.73', '1.0.74', '1.0.75', '1.0.76'].includes(pkg.version)) errors.push(`package version must be 1.0.62 or 1.0.63, got ${pkg.version}`);
