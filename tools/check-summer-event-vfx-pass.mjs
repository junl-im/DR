...
if (!['1.0.49', '1.0.50'].includes(pkg.version)) errors.push(`package version must be 1.0.49 or 1.0.50, got ${pkg.version}`);
...
has(main, 'v1050-summer-finale-event-vfx', 'summer event VFX token');
has(main, 'v1050-summer-finale-pass-shop', 'summer pass missions token');
...
has(main, 'v1050-finale-compact-carousel', 'compact chapter carousel token');
has(main, 'v1050-boss-finale-polish', 'boss season polish token');
...
has(index, 'data-season-vfx="v1050-summer-finale-event-vfx"', 'season VFX lobby mount');
has(index, 'data-season-pass="v1050-summer-finale-pass-shop"', 'pass missions lobby mount');
has(css, 'season-pass-missions', 'pass missions CSS');
has(css, 'v1050-summer-design-gesture-qa', 'season gesture QA CSS');
has(css, 'v1050-finale-compact-carousel', 'compact carousel CSS');
has(css, 'v1050-boss-finale-polish', 'boss season polish CSS');
has(sw, 'dream-library-cache-v1.0.50', 'service worker v1.0.49 cache');
has(sw, 'texture-atlas-manifest-v1.0.50.json', 'v1.0.49 atlas manifest preload');
if (!existsSync('public/assets/meta/texture-atlas-manifest-v1.0.50.json')) errors.push('missing v1.0.49 texture atlas manifest');
