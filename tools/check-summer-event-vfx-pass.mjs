...
if (!['1.0.49', '1.0.50', '1.0.51', '1.0.52', '1.0.53', '1.0.54', '1.0.55', '1.0.56', '1.0.57'].includes(pkg.version)) errors.push(`package version must be 1.0.49-1.0.53, got ${pkg.version}`);
