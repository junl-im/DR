...
if (!['1.0.49', '1.0.50', '1.0.51'].includes(pkg.version)) errors.push(`package version must be 1.0.49 or 1.0.50, got ${pkg.version}`);
...
has(main, 'v1051-summer-shop-claim-vfx', 'summer event VFX token');
has(main, 'v1051-summer-shop-claim-pass', 'summer pass missions token');
...
has(main, 'v1051-auto-focus-compact-carousel', 'compact chapter carousel token');
has(main, 'v1051-boss-season-icon-readability', 'boss season polish token');
...
has(index, 'data-season-vfx="v1051-summer-shop-claim-vfx"', 'season VFX lobby mount');
has(index, 'data-season-pass="v1051-summer-shop-claim-pass"', 'pass missions lobby mount');
has(css, 'season-pass-missions', 'pass missions CSS');
has(css, 'v1051-mobile-design-gesture-final', 'season gesture QA CSS');
has(css, 'v1051-auto-focus-compact-carousel', 'compact carousel CSS');
has(css, 'v1051-boss-season-icon-readability', 'boss season polish CSS');
has(sw, 'dream-library-cache-v1.0.51', 'service worker v1.0.49 cache');
has(sw, 'texture-atlas-manifest-v1.0.51.json', 'v1.0.49 atlas manifest preload');
if (!existsSync('public/assets/meta/texture-atlas-manifest-v1.0.51.json')) errors.push('missing v1.0.49 texture atlas manifest');
