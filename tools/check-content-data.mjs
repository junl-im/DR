...
const requiredMainTokens = ['renderRestoration', 'renderCollection', 'openRestorationDetail', 'loadDailyLeaderboard', 'dream-library-inventory', 'chapterTabs', 'initBackNavigation', 'handleSoftBack', 'exitToFirstScreen', 'handleSpecialTileGate', 'triggerBossTelegraph', 'renderLobbyMissionDeck', 'loadAudioRuntime', 'loadSpineRuntime'];
const requiredHtmlTokens = ['collection-list', 'daily-leaderboard-list', 'restoration-detail-modal', 'boss-image', 'boss-pattern', 'exit-confirm-modal', 'exit-confirm-button', 'boss-telegraph', 'lobby-mission-deck'];
const missing = [
...
console.log('Content data policy passed for v1.0.14.');
