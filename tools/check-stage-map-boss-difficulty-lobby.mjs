...
requireText(main, 'v1054-engine-design-gesture-qa', 'lobby final gesture token');
requireText(main, 'v1054-finale-tempo-audio-balance', 'difficulty tempo token');
...
requireText(main, 'dy > 1.2', 'deeper lobby drag rescue threshold');
requireText(main, 'dx * 0.28', 'lobby drag horizontal tolerance');
...
console.log('Stage map comfort, boss left statusbar portrait, difficulty tempo and lobby gesture final QA passed for v1.0.77.');
