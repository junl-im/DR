...
for (const token of [
  ...
  'drawBossWarningLane(power, pattern, bossId)'
]) {
...
for (const token of [
  'data-objective-marker-density="compressed"',
  'data-boss-visual-stack="stable-atlas-v1038"',
  ...
  if (!css.includes(token)) errors.push(`CSS missing v1.0.38 polish token: ${token}`);
}
