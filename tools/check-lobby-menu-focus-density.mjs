...
if (!['1.0.74', '1.0.75', '1.0.76', '1.0.77', '1.0.78', '1.0.79', '1.0.80', '1.0.81'].includes(files.pkg.version)) errors.push(`package version must be 1.0.74 or 1.0.75, got ${files.pkg.version}`);
[
