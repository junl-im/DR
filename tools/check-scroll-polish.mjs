...
const required = [
  [main.includes('let dragLocked = false') && main.includes('dy > 1.2') && main.includes('dy > dx * 0.28') && main.includes('shell.scrollTop -= deltaY * 1.28') && main.includes('elapsed < 900'), 'lobby drag guard thresholds were not updated'],
...
console.log('Scroll, tap and ranking polish policy passed with live drag thresholds.');
