...
const required = [
  [main.includes('let dragLocked = false') && main.includes('dy > 7') && main.includes('elapsed < 1100'), 'lobby drag guard thresholds were not updated'],
  ...
  [css.includes('rank-source-note') && main.includes('Cloud 기록과 기기 기록을 함께 표시합니다.'), 'ranking source note polish missing']
];
...
console.log('Scroll, tap and ranking polish policy passed for v1.0.23.');
