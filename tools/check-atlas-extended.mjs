...
const checks = [
  ...
  [difficulty.includes('texture-atlas-manifest-v1.0.45.json'), 'v1.0.45 manifest not referenced'],
  [sw.includes('texture-atlas-manifest-v1.0.45.json') && sw.includes('dream-library-cache-v1.0.45'), 'service worker v1.0.45 cache/manifest missing']
];
for (const file of ['public/assets/atlas/v2-tiles.png', 'public/assets/atlas/v2-tiles.atlas.json', 'public/assets/atlas/boss-frames-v2.png', 'public/assets/atlas/boss-frames-v2.atlas.json', 'public/assets/meta/texture-atlas-manifest-v1.0.45.json']) {
...
console.log('Extended atlas lookup policy passed for v1.0.45.');
