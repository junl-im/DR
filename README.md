...
7. Summary에 `Apply 꿈의 서고 v1.0.6 no SVG raster asset patch` 입력합니다.
...
v1.0.6부터 에셋은 SVG를 사용하지 않습니다. 모든 게임 표시 자원은 2D~3D 렌더링 기반 PNG/WebP와 Texture Atlas 기준으로 관리합니다.
...
### v1.0.7 예정 - Boss Battle Feedback Patch
