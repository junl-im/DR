...
### v1.0.32 예정 - Objective Markers, Camera Tutorial and Boss Pattern Polish Patch

- 이번 선택 셀 내부 제한이 실제 모바일에서도 충분한지 추가 QA
