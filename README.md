...
### v1.0.26 예정 - Pixi Boss Layer + In-App Device QA + Ranking Flow Patch

- v1.0.25의 카카오 로비 회전 수정 결과를 실제 기기 기준으로 추가 점검
