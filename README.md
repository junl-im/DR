...
### v1.0.38 예정 - Boss Pattern Depth, Objective Marker Density and Mobile Flow Polish Patch

- 보스 3종별 warning lane, 피격 cut-in, 반격 패턴을 더 명확하게 차별화
- boss stable image fallback과 atlas overlay가 작은 화면에서도 겹쳐 보이지 않도록 추가 polish
