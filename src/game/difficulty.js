...
export const ATLAS_ASSETS = [
  ...
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.63.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.62.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.61.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.60.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.59.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.57.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.56.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.55.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.54.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.53.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.49.json`,
  `${import.meta.env.BASE_URL}assets/meta/texture-atlas-manifest-v1.0.47.json`
];

export const PRELOAD_ASSETS = [
  // v1.0.36: keep packed tile, boss atlas and compressed candidates explicit so Actions policy checks never miss them.
  ...TILE_ATLAS_ASSETS,
  ...BOSS_FRAME_ATLAS_ASSETS,
  ...ATLAS_WEBP_ASSETS,
  ...ATLAS_ASSETS,
