...
function renderBossPanel() {
  ...
  bossLane?.setAttribute('data-boss-status-readability', BOSS_STATUSBAR_READABILITY_PATCH);
  bossLane?.setAttribute('data-boss-status-balance', BOSS_STATUSBAR_BALANCE_PATCH);
  battleStage?.setAttribute('data-camera-gesture-separation', CAMERA_GESTURE_SEPARATION_PATCH);
  battleStage?.setAttribute('data-real-device-camera-feel', REAL_DEVICE_CAMERA_FEEL_PATCH);
  battleStage?.setAttribute('data-boss-status-balance', BOSS_STATUSBAR_BALANCE_PATCH);
  battleStage?.setAttribute('data-boss-status-priority', BOSS_STATUS_PRIORITY_PATCH);
  battleStage?.setAttribute('data-image-boot-budget', IMAGE_BOOT_BUDGET_PATCH);
  el.bossCore.dataset.bossStatusBalance = BOSS_STATUSBAR_BALANCE_PATCH;
  el.bossCore.dataset.bossStatusPriority = BOSS_STATUS_PRIORITY_PATCH;
  el.bossCore.setAttribute('data-image-boot-budget', IMAGE_BOOT_BUDGET_PATCH);
  el.bossLaneEcho?.setAttribute('data-boss-status-balance', BOSS_STATUSBAR_BALANCE_PATCH);
  el.bossLaneEcho?.setAttribute('data-boss-status-priority', BOSS_STATUS_PRIORITY_PATCH);
  ...
  battleStage?.setAttribute('data-low-end-render-guard', LOW_END_RENDER_BUDGET_GUARD_PATCH);
  document.querySelector<HTMLElement>('.boss-lane')?.setAttribute('data-boss-status-priority', BOSS_STATUS_PRIORITY_PATCH);
  document.querySelector<HTMLElement>('.boss-info')?.setAttribute('data-boss-status-priority', BOSS_STATUS_PRIORITY_PATCH);
  document.querySelector<HTMLElement>('.boss-role-stack')?.setAttribute('data-boss-status-priority', BOSS_STATUS_PRIORITY_PATCH);
  document.querySelector<HTMLElement>('#boss-attack-preview')?.setAttribute('data-boss-status-priority', BOSS_STATUS_PRIORITY_PATCH);
